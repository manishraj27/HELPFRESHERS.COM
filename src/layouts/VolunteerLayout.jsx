  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-indigo-800 text-white">
        <div className="p-4">
          <h2 className="text-2xl font-bold">Volunteer Portal</h2>
        </div>
        <nav className="mt-8">
          <div className="px-4 space-y-2">
            ...
            <button
              ...
              className="w-full text-left px-4 py-2 rounded-lg hover:bg-indigo-700 transition-colors text-red-300 hover:text-red-200"
            >
              Logout
            </button>
          </div>
